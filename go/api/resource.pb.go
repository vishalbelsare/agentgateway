...
func (PolicySpec_LocalRateLimit_Type) EnumDescriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{22, 0, 0}
}
...
func (PolicySpec_InferenceRouting_FailureMode) EnumDescriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{22, 3, 0}
}
...
func (*PolicySpec_InferenceRouting) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{22, 3}
}
...
func (*PolicySpec_BackendTLS) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{22, 4}
}
...
func (*AIBackend_Gemini) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{26, 2}
}
...
func (*AIBackend_Vertex) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{26, 3}
}
...
func (*AIBackend_Anthropic) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{26, 4}
}
...
func (*AIBackend_Bedrock) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{26, 5}
}
...
const file_resource_proto_rawDesc = "" +
	...
	"\abackoff\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\abackoff\"\x92\x02\n" +
	"\n" +
	"RouteMatch\x128\n" +
...
var file_resource_proto_goTypes = []any{
	...
	(*RouteMatch)(nil),                           // 11: agentgateway.dev.resource.RouteMatch
	(*PathMatch)(nil),                            // 12: agentgateway.dev.resource.PathMatch
	(*QueryMatch)(nil),                           // 13: agentgateway.dev.resource.QueryMatch
	(*MethodMatch)(nil),                          // 14: agentgateway.dev.resource.MethodMatch
	(*HeaderMatch)(nil),                          // 15: agentgateway.dev.resource.HeaderMatch
	(*RouteFilter)(nil),                          // 16: agentgateway.dev.resource.RouteFilter
	(*CORS)(nil),                                 // 17: agentgateway.dev.resource.CORS
	(*DirectResponse)(nil),                       // 18: agentgateway.dev.resource.DirectResponse
	(*HeaderModifier)(nil),                       // 19: agentgateway.dev.resource.HeaderModifier
	(*RequestMirror)(nil),                        // 20: agentgateway.dev.resource.RequestMirror
	(*RequestRedirect)(nil),                      // 21: agentgateway.dev.resource.RequestRedirect
	(*UrlRewrite)(nil),                           // 22: agentgateway.dev.resource.UrlRewrite
	(*Header)(nil),                               // 23: agentgateway.dev.resource.Header
	(*RouteBackend)(nil),                         // 24: agentgateway.dev.resource.RouteBackend
	(*PolicyTarget)(nil),                         // 25: agentgateway.dev.resource.PolicyTarget
	(*PolicySpec)(nil),                           // 26: agentgateway.dev.resource.PolicySpec
	(*Policy)(nil),                               // 27: agentgateway.dev.resource.Policy
	(*Backend)(nil),                              // 28: agentgateway.dev.resource.Backend
	(*StaticBackend)(nil),                        // 29: agentgateway.dev.resource.StaticBackend
	(*AIBackend)(nil),                            // 30: agentgateway.dev.resource.AIBackend
	(*MCPBackend)(nil),                           // 31: agentgateway.dev.resource.MCPBackend
	(*MCPTarget)(nil),                            // 32: agentgateway.dev.resource.MCPTarget
	(*BackendReference)(nil),                     // 33: agentgateway.dev.resource.BackendReference
	(*PolicySpec_LocalRateLimit)(nil),            // 34: agentgateway.dev.resource.PolicySpec.LocalRateLimit
	(*PolicySpec_ExternalAuth)(nil),              // 35: agentgateway.dev.resource.PolicySpec.ExternalAuth
	(*PolicySpec_A2A)(nil),                       // 36: agentgateway.dev.resource.PolicySpec.A2a
	(*PolicySpec_InferenceRouting)(nil),          // 37: agentgateway.dev.resource.PolicySpec.InferenceRouting
	(*PolicySpec_BackendTLS)(nil),                // 38: agentgateway.dev.resource.PolicySpec.BackendTLS
	nil,                                          // 39: agentgateway.dev.resource.PolicySpec.ExternalAuth.ContextEntry
	(*AIBackend_Override)(nil),                   // 40: agentgateway.dev.resource.AIBackend.Override
	(*AIBackend_OpenAI)(nil),                     // 41: agentgateway.dev.resource.AIBackend.OpenAI
	(*AIBackend_Gemini)(nil),                     // 42: agentgateway.dev.resource.AIBackend.Gemini
	(*AIBackend_Vertex)(nil),                     // 43: agentgateway.dev.resource.AIBackend.Vertex
	(*AIBackend_Anthropic)(nil),                  // 44: agentgateway.dev.resource.AIBackend.Anthropic
	(*AIBackend_Bedrock)(nil),                    // 45: agentgateway.dev.resource.AIBackend.Bedrock
	(*duration.Duration)(nil),                    // 46: google.protobuf.Duration
	(*wrappers.BytesValue)(nil),                  // 47: google.protobuf.BytesValue
...
var file_resource_proto_depIdxs = []int32{
	...
	28, // 3: agentgateway.dev.resource.Resource.backend:type_name -> agentgateway.dev.resource.Backend
	27, // 4: agentgateway.dev.resource.Resource.policy:type_name -> agentgateway.dev.resource.Policy
	...
	11, // 7: agentgateway.dev.resource.Route.matches:type_name -> agentgateway.dev.resource.RouteMatch
	16, // 8: agentgateway.dev.resource.Route.filters:type_name -> agentgateway.dev.resource.RouteFilter
	24, // 9: agentgateway.dev.resource.Route.backends:type_name -> agentgateway.dev.resource.RouteBackend
	9,  // 10: agentgateway.dev.resource.Route.traffic_policy:type_name -> agentgateway.dev.resource.TrafficPolicy
	46, // 11: agentgateway.dev.resource.TrafficPolicy.backend_request_timeout:type_name -> google.protobuf.Duration
	46, // 12: agentgateway.dev.resource.TrafficPolicy.request_timeout:type_name -> google.protobuf.Duration
	10, // 13: agentgateway.dev.resource.TrafficPolicy.retry:type_name -> agentgateway.dev.resource.Retry
	46, // 14: agentgateway.dev.resource.Retry.backoff:type_name -> google.protobuf.Duration
	12, // 15: agentgateway.dev.resource.RouteMatch.path:type_name -> agentgateway.dev.resource.PathMatch
	15, // 16: agentgateway.dev.resource.RouteMatch.headers:type_name -> agentgateway.dev.resource.HeaderMatch
	14, // 17: agentgateway.dev.resource.RouteMatch.method:type_name -> agentgateway.dev.resource.MethodMatch
	13, // 18: agentgateway.dev.resource.RouteMatch.query_params:type_name -> agentgateway.dev.resource.QueryMatch
	19, // 19: agentgateway.dev.resource.RouteFilter.request_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	19, // 20: agentgateway.dev.resource.RouteFilter.response_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	21, // 21: agentgateway.dev.resource.RouteFilter.request_redirect:type_name -> agentgateway.dev.resource.RequestRedirect
	22, // 22: agentgateway.dev.resource.RouteFilter.url_rewrite:type_name -> agentgateway.dev.resource.UrlRewrite
	20, // 23: agentgateway.dev.resource.RouteFilter.request_mirror:type_name -> agentgateway.dev.resource.RequestMirror
	18, // 24: agentgateway.dev.resource.RouteFilter.direct_response:type_name -> agentgateway.dev.resource.DirectResponse
	17, // 25: agentgateway.dev.resource.RouteFilter.cors:type_name -> agentgateway.dev.resource.CORS
	46, // 26: agentgateway.dev.resource.CORS.max_age:type_name -> google.protobuf.Duration
	23, // 27: agentgateway.dev.resource.HeaderModifier.add:type_name -> agentgateway.dev.resource.Header
	23, // 28: agentgateway.dev.resource.HeaderModifier.set:type_name -> agentgateway.dev.resource.Header
	33, // 29: agentgateway.dev.resource.RequestMirror.backend:type_name -> agentgateway.dev.resource.BackendReference
	33, // 30: agentgateway.dev.resource.RouteBackend.backend:type_name -> agentgateway.dev.resource.BackendReference
	16, // 31: agentgateway.dev.resource.RouteBackend.filters:type_name -> agentgateway.dev.resource.RouteFilter
	34, // 32: agentgateway.dev.resource.PolicySpec.local_rate_limit:type_name -> agentgateway.dev.resource.PolicySpec.LocalRateLimit
	35, // 33: agentgateway.dev.resource.PolicySpec.ext_authz:type_name -> agentgateway.dev.resource.PolicySpec.ExternalAuth
	36, // 34: agentgateway.dev.resource.PolicySpec.a2a:type_name -> agentgateway.dev.resource.PolicySpec.A2a
	37, // 35: agentgateway.dev.resource.PolicySpec.inference_routing:type_name -> agentgateway.dev.resource.PolicySpec.InferenceRouting
	38, // 36: agentgateway.dev.resource.PolicySpec.backend_tls:type_name -> agentgateway.dev.resource.PolicySpec.BackendTLS
	25, // 37: agentgateway.dev.resource.Policy.target:type_name -> agentgateway.dev.resource.PolicyTarget
	26, // 38: agentgateway.dev.resource.Policy.spec:type_name -> agentgateway.dev.resource.PolicySpec
	29, // 39: agentgateway.dev.resource.Backend.static:type_name -> agentgateway.dev.resource.StaticBackend
	30, // 40: agentgateway.dev.resource.Backend.ai:type_name -> agentgateway.dev.resource.AIBackend
	31, // 41: agentgateway.dev.resource.Backend.mcp:type_name -> agentgateway.dev.resource.MCPBackend
	40, // 42: agentgateway.dev.resource.AIBackend.override:type_name -> agentgateway.dev.resource.AIBackend.Override
	41, // 43: agentgateway.dev.resource.AIBackend.openai:type_name -> agentgateway.dev.resource.AIBackend.OpenAI
	42, // 44: agentgateway.dev.resource.AIBackend.gemini:type_name -> agentgateway.dev.resource.AIBackend.Gemini
	43, // 45: agentgateway.dev.resource.AIBackend.vertex:type_name -> agentgateway.dev.resource.AIBackend.Vertex
	44, // 46: agentgateway.dev.resource.AIBackend.anthropic:type_name -> agentgateway.dev.resource.AIBackend.Anthropic
	45, // 47: agentgateway.dev.resource.AIBackend.bedrock:type_name -> agentgateway.dev.resource.AIBackend.Bedrock
	32, // 48: agentgateway.dev.resource.MCPBackend.targets:type_name -> agentgateway.dev.resource.MCPTarget
	33, // 49: agentgateway.dev.resource.MCPTarget.backend:type_name -> agentgateway.dev.resource.BackendReference
	3,  // 50: agentgateway.dev.resource.MCPTarget.protocol:type_name -> agentgateway.dev.resource.MCPTarget.Protocol
	46, // 51: agentgateway.dev.resource.PolicySpec.LocalRateLimit.fill_interval:type_name -> google.protobuf.Duration
	1,  // 52: agentgateway.dev.resource.PolicySpec.LocalRateLimit.type:type_name -> agentgateway.dev.resource.PolicySpec.LocalRateLimit.Type
	33, // 53: agentgateway.dev.resource.PolicySpec.ExternalAuth.target:type_name -> agentgateway.dev.resource.BackendReference
	39, // 54: agentgateway.dev.resource.PolicySpec.ExternalAuth.context:type_name -> agentgateway.dev.resource.PolicySpec.ExternalAuth.ContextEntry
	33, // 55: agentgateway.dev.resource.PolicySpec.InferenceRouting.endpoint_picker:type_name -> agentgateway.dev.resource.BackendReference
	2,  // 56: agentgateway.dev.resource.PolicySpec.InferenceRouting.failure_mode:type_name -> agentgateway.dev.resource.PolicySpec.InferenceRouting.FailureMode
	47, // 57: agentgateway.dev.resource.PolicySpec.BackendTLS.cert:type_name -> google.protobuf.BytesValue
	47, // 58: agentgateway.dev.resource.PolicySpec.BackendTLS.key:type_name -> google.protobuf.BytesValue
	47, // 59: agentgateway.dev.resource.PolicySpec.BackendTLS.root:type_name -> google.protobuf.BytesValue
	48, // 60: agentgateway.dev.resource.PolicySpec.BackendTLS.insecure:type_name -> google.protobuf.BoolValue
	49, // 61: agentgateway.dev.resource.AIBackend.OpenAI.model:type_name -> google.protobuf.StringValue
	49, // 62: agentgateway.dev.resource.AIBackend.Gemini.model:type_name -> google.protobuf.StringValue
	49, // 63: agentgateway.dev.resource.AIBackend.Vertex.model:type_name -> google.protobuf.StringValue
	49, // 64: agentgateway.dev.resource.AIBackend.Anthropic.model:type_name -> google.protobuf.StringValue
	49, // 65: agentgateway.dev.resource.AIBackend.Bedrock.model:type_name -> google.protobuf.StringValue
